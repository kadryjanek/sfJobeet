...
use Bootcamp\JobeetBundle\Form\JobFilterType;
...
class JobController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new JobFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('BootcampJobeetBundle:Job')->createQueryBuilder('e');
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has('JobControllerFilter')) {
                ...
                $filterForm = $this->createForm(new JobFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('job', array('page' => $page));
        };
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BootcampJobeetBundle:Job:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BootcampJobeetBundle:Job:edit.html.twig', array(
            'entity'      => $entity,
