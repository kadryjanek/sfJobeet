...
class JobFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('companyName', 'filter_text')
            ->add('type', 'filter_number_range')
            ->add('logo', 'filter_text')
            ->add('url', 'filter_text')
            ->add('position', 'filter_text')
            ->add('location', 'filter_text')
            ->add('description', 'filter_text')
            ->add('howToApply', 'filter_number_range')
    ...
    {
        return 'bootcamp_jobeetbundle_jobfiltertype';
    }
}
